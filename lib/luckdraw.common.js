...
// CONCATENATED MODULE: ./packages/luck-draw/luck-draw.vue?vue&type=template&id=6d3d5dee&
...
var luck_drawvue_type_script_lang_ts_default_1 = /*#__PURE__*/function (_Vue) {
  ...
  _createClass(default_1, [{
    ...
    value: function drawOutRing() {
      ...
      var offsetY = this.radius - this.borderWidth * 0.5;
    ...
    value: function drawBtn() {
      ...
      var innerRing = this.btnSize - 5;

      var btnSceneFunc = function btnSceneFunc(context, shape) {
        var radius = shape.getAttr('radius');
        context.beginPath(); // 计算箭头y坐标

        var y = _this3.radius - radius * 1.4;
        context.moveTo(_this3.radius, y);
        context.arc(_this3.radius, _this3.radius, radius, -Math.PI * 0.44, Math.PI + Math.PI * 0.44, false);
        context.closePath();
    ...
    value: function handleInnerRingAnimation() {
      ...
      new Tween["Tween"]({
        ...
        onFinish: function onFinish() {
          ...
          if (_this5.slowDownTurns == 4 && angle + _this5.innerPrizes[_this5.checkedIndex].angle == 360) {
            _this5.stop();
...
/******/ });
//# sourceMappingURL=luckdraw.common.js.map